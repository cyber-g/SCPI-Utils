...
parser.add_argument('-i', '--ip', default='192.168.1.45', help='IP address of the instrument')
...
scpih.send(sock, f'MMEM:STOR:IMAG "{args.remote_filename}"')

# Request the file via BINBLOCK
data = scpih.query_binblock(sock, f'MMEM:DATA? "{args.remote_filename}"')
